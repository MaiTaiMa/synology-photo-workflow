...
Datei: tests/test_state_and_face_v77.py
...
def test_state_transition_cannot_move_backward(tmp_path):
 p=tmp_path/'batch.json';write_state(p,'x','phase2_archiving')
 with pytest.raises(ValueError,match='backwards'):write_state(p,'x','phase1_completed')
