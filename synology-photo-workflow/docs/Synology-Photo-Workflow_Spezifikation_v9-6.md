<!--
Synology Photo Workflow – Spezifikation v9.6
Datei: docs/Synology-Photo-Workflow_Spezifikation_v9-6.md
...
Äı ̈nderungen in v9.6: AP4-Umsetzung (Vollst ändigkeits- und Koh ärenzpr üfung: Datenvertrags-Vervollst ändigung, Fehlervertrags-Koh ärenz, Metadaten-Vertrag-Pr äzisierung, Score-Vertrag-Vervollst ändigung, Archiv-Vertrag-Koh ärenz, WorkUnit-Vertrag-Pr äzisierung, Face-Backend-Vertrag-Vervollst ändigung, Manual-Keep-Vertrag-Pr äzisierung, Konfigurations-Vertrag-Koh ärenz, Reporting-Vertrag-Vervollst ändigung).
-->
